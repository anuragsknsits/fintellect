...
import { forgetPasswordRequest } from '../redux/actions/authAction';
...
const ForgotPasswordPage = () => {
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-white shadow-lg rounded-md">
      <Meta title="Forgot Password | FINTELLECT" description="Reset your FINTELLECT password." />
      <h2 className="text-2xl font-semibold text-gray-700 mb-4">Forgot Password</h2>
      {error && <p className="text-red-500">{error}</p>}
      {success && <p className="text-green-500">Reset link sent! Check your email.</p>}
